public class Rectangle extends Shape {
    ...
    public boolean isInBoundary() {
        if (-1 * getScreenSize() > this.x - this.width / 2 || Rectangle.getScreenSize() < this.x + this.width / 2) {
            return false;
        }
        return !(-1 * getScreenSize() > this.y - this.height / 2) && !(Rectangle.getScreenSize() < this.y + this.height / 2);
    }
