...
public class Circle extends Shape {
    ...
    //子类继承父类时，一定要在构造方法的第一行用super去调用父类的构造方法；
    ...
    public void checkColor() {
        //子类中无set方法，故写不写super无所谓，默认调用父类的set方法；
        if (isInBoundary()) {
    ...
    @Override
    //子类toString方法的重写；
    //类比关键词this，翻译为“我（对象）的某某某（方法或属性）”，找到自己的全局方法或属性；
    //这里通过关键词super，翻译为“我（对象）的父类的某某某（方法或属性）”，这里进入到父类的toString方法中去；
